function Footer() {
  return (
    <footer class="flex justify-center px-4 text-white bg-primary dark:text-white dark:bg-gray-800">
        ...
        <div class="flex flex-col items-center justify-between mt-6 md:flex-row">
          ...
          <div class="flex mt-4 md:m-0">
            <div class="-mx-4">
              <a
                href="#"
                class="px-4 text-sm font-medium text-white hover:text-gray-200 hover:underline"
              >
                About
              </a>
              <a
